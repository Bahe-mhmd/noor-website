...
export const LESSONS = [
  ...
  // ──────────────────────────────────────────────
  {
    id: 'sahih_muslim_alkhamees',
    title: 'Sahih Muslim — Complete Explanation',
    speaker: 'Dr. Othman Al-Khamees',
    category: 'hadith',
    level: 'intermediate',
    lang: 'ar',
    description: 'A comprehensive scholarly explanation of Sahih Muslim, one of the most authentic hadith collections in Islam.',
    playlistId: 'PLx3Fh1kiMbrcDYytEoWVt7bHqyP2iNjnn',
    videos: [
      { id:'EP3Ss6Szn9o', title:'Lesson 1 — Introduction to Sahih Muslim',              duration:'1h 37min' },
      { id:'uMDuOxTKOXk', title:'Lesson 2 — The Chapter of Faith (Kitab al-Iman)',      duration:'1h 22min' },
      { id:'XGuKPSGFMnY', title:'Lesson 3 — Pillars of Islam Explained',                duration:'1h 45min' },
      { id:'TiAQpR5AGFg', title:'Lesson 4 — Kitab al-Taharah (Purification)',           duration:'1h 18min' },
      { id:'wKGjdNkMxRQ', title:'Lesson 5 — Ablution & Its Conditions',                 duration:'1h 30min' },
      { id:'OmrSPmGrGME', title:'Lesson 6 — Kitab al-Salah — The Prayer',              duration:'1h 52min' },
      { id:'dDwdCRq-8i4', title:'Lesson 7 — Times of Prayer & Their Virtues',          duration:'1h 25min' },
      { id:'Ot-4J2hJNcE', title:'Lesson 8 — Kitab al-Zakat',                           duration:'1h 10min' },
      { id:'EP3Ss6Szn9o', title:'Lesson 9 — Kitab al-Siyam — Fasting',                duration:'1h 40min' },
      { id:'uMDuOxTKOXk', title:'Lesson 10 — Kitab al-Hajj — Pilgrimage',             duration:'2h 05min' },
    ]
  },
  {
    id: 'arbaeen_nawawi',
